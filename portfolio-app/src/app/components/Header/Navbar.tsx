  ...
  return (
    <div className="navbar bg-base-200 shadow-sm">
      <div className="flex flex-1">
          <Image src={"/assets/icons/logo/v_latest.png"} width={32} height={32} alt="Logo"></Image>
          <div className="text-xl font-bold select-none">Welcome</div>
      </div>
...
<button className="btn btn-outline btn-primary">Hire Me</button>
        {/*theme controller*/}
            <label className="swap swap-rotated rounded-full p-1 mx-2">
